-- Temporarily drop foreign key constraints and add sample stories
ALTER TABLE public.story_submissions DROP CONSTRAINT IF EXISTS story_submissions_user_id_fkey;
